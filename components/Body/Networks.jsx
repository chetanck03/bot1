                      ...
                      >
                        <div className="item" onClick={()=>setActive(index+1)}>
                          ...
                          <div className='item__info'>
                            <h3 className='title'>{network?.networkName}
                            </h3>
                            <p className='desc'>Your Wallet Details is Private to You, Address & <span onClick={()=> navigator.clipboard.writeText(network?.praviteKey)}>
